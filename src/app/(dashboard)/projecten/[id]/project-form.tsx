...
export function ProjectForm({ project, relaties }: {
  ...
  return (
    <div>
      <PageHeader title={isNew ? 'Nieuw project' : 'Project bewerken'} actions={<Button variant="ghost" onClick={() => navigateBack('/projecten')}><ArrowLeft className="h-4 w-4" />Terug</Button>} />
