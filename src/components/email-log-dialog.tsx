...
import { Mail, Paperclip, Loader2, Download, ExternalLink } from 'lucide-react'
                ...
                {bijlagen.map((b: BijlageMeta, i: number) => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full flex items-center gap-2 px-3 py-2 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-md text-sm text-left transition-colors"
                    >
                      ...
                      ) : b.storage_path || b.kind === 'offerte_pdf' || b.kind === 'tekeningen_pdf' || b.kind === 'factuur_pdf' || b.filename.startsWith('Offerte-') || b.filename.startsWith('Tekeningen-') ? (
                        <ExternalLink className="h-3.5 w-3.5 text-blue-600" />
                      ) : (
                        <span className="text-xs text-blue-500">Niet gearchiveerd</span>
                      )}
                    </button>
                  )
                })}
